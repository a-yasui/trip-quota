                    ...
                    <div class="px-6 py-4">
                        <dl class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <dd class="text-sm font-medium text-green-600">{{ $group->members->where('status', 'CONFIRMED')->count() }}人</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">未確認</dt>
                                <dd class="text-sm font-medium text-yellow-600">{{ $group->members->where('status', 'UNCONFIRMED')->count() }}人</dd>
                            </div>
                        </dl>
                    </div>
                </div>
