...
@section('title', '旅程編集 - ' . $travelPlan->plan_name)

@section('content')
    @component('components.container', ['class' => 'max-w-4xl'])
        @component('components.page-header', ['title' => '旅程編集', 'subtitle' => $travelPlan->plan_name . 'の旅程を編集します。'])
        @endcomponent
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form method="POST" action="{{ route('travel-plans.itineraries.update', [$travelPlan->uuid, $itinerary->id]) }}" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="4"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="詳細な内容、持参物、注意事項などを記載してください...">{{ old('description', $itinerary->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="date" 
                                       id="date" 
                                       name="date" 
                                       value="{{ old('date', $itinerary->date->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       id="arrival_date" 
                                       name="arrival_date" 
                                       value="{{ old('arrival_date', $itinerary->arrival_date?->format('Y-m-d')) }}"
                                       min="{{ $travelPlan->departure_date->format('Y-m-d') }}"
                                       @if($travelPlan->return_date) max="{{ $travelPlan->return_date->format('Y-m-d') }}" @endif
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                @error('arrival_date')
                            ...
                            <div>
                                ...
                                <input type="time" 
                                       id="start_time" 
                                       name="start_time" 
                                       value="{{ old('start_time', $itinerary->start_time?->format('H:i')) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                @error('start_time')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <select name="group_id" id="group_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                ...
                                @foreach($groups as $group)
                                    <option value="{{ $group->id }}" {{ old('group_id', $itinerary->group_id) == $group->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" 
                                               id="airline" 
                                               name="airline" 
                                               value="{{ old('airline', $itinerary->airline) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               id="flight_number" 
                                               name="flight_number" 
                                               value="{{ old('flight_number', $itinerary->flight_number) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                               placeholder="例：JL123">
                                        @error('flight_number')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('departure_airport', $itinerary->departure_airport) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                               placeholder="例：羽田空港">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('arrival_airport', $itinerary->arrival_airport) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" 
                                               id="train_line" 
                                               name="train_line" 
                                               value="{{ old('train_line', $itinerary->train_line) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               id="train_type" 
                                               name="train_type" 
                                               value="{{ old('train_type', $itinerary->train_type) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('departure_station', $itinerary->departure_station) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                               placeholder="例：東京駅">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('arrival_station', $itinerary->arrival_station) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                               placeholder="例：新大阪駅">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" 
                                               id="company" 
                                               name="company" 
                                               value="{{ old('company', $itinerary->company) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('departure_terminal', $itinerary->departure_terminal) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('arrival_terminal', $itinerary->arrival_terminal) }}"
                                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('departure_location', $itinerary->departure_location) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('arrival_location', $itinerary->arrival_location) }}"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        ...
                        <div>
                            ...
                            <textarea id="notes" 
                                      ...
                                      rows="3"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="その他のメモや特記事項...">{{ old('notes', $itinerary->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
