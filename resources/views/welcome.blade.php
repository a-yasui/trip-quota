...
<head>
    ...
    <title>{{ config('app.name', 'TripQuota') }}</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        @auth
                            <span class="text-gray-700">こんにちは、{{ Auth::user()->account_name }}さん</span>
            ...
            <div class="text-center">
                ...
                @guest
                    <div class="space-x-4 mb-12">
                        <a href="{{ route('login') }}" class="bg-indigo-600 text-white px-8 py-3 rounded-lg text-lg hover:bg-indigo-700 transition duration-200">
                            ログイン
                        </a>
                        <a href="{{ route('register') }}" class="bg-green-600 text-white px-8 py-3 rounded-lg text-lg hover:bg-green-700 transition duration-200">
                            無料で始める
                        </a>
                    </div>
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('oauth.redirect', 'google') }}" class="w-full bg-red-500 text-white px-6 py-3 rounded-lg hover:bg-red-600 transition duration-200 flex items-center justify-center">
                            ...
                            <a href="{{ route('oauth.redirect', 'github') }}" class="w-full bg-gray-800 text-white px-6 py-3 rounded-lg hover:bg-gray-900 transition duration-200 flex items-center justify-center">
