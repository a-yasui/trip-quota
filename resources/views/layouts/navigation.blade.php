<nav class="bg-white border-b border-gray-100">
    ...
    <div id="responsive-nav-menu" class="hidden sm:hidden">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (hamburgerButton && responsiveNavMenu && hamburgerIcon && closeIcon) {
            hamburgerButton.addEventListener('click', function() {
                const isOpen = !responsiveNavMenu.classList.contains('hidden');
                ...
                if (isOpen) {
                    ...
                    // メニューを開く
                    responsiveNavMenu.classList.remove('hidden');
