            ...
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    ...
                    <div class="mt-2 flex items-center text-sm text-gray-500">
                        ...
                        <span>
                            <?php echo e($travelPlan->departure_date->format('Y年n月d日')); ?>

                            <?php if($travelPlan->return_date): ?>
                                〜 <?php echo e($travelPlan->return_date->format('Y年n月d日')); ?>
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="px-6 py-4 space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900"><?php echo e($travelPlan->created_at->format('Y年n月d日 H:i')); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">最終更新</dt>
                            <dd class="mt-1 text-sm text-gray-900"><?php echo e($travelPlan->updated_at->format('Y年n月d日 H:i')); ?></dd>
                        </div>
                    </div>
                </div>
