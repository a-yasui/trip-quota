<?php $__env->startSection('title', '班グループ編集 - ' . $group->name); ?>

<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.container', ['class' => 'max-w-3xl']); ?>
        <?php $__env->startComponent('components.page-header', ['title' => '班グループ編集', 'subtitle' => $travelPlan->plan_name . ' - ' . $group->name]); ?>
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form method="POST" action="<?php echo e(route('travel-plans.groups.update', [$travelPlan->uuid, $group->id])); ?>" class="space-y-6 p-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              rows="4"
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              placeholder="このグループの目的や活動内容を入力してください..."><?php echo e(old('description', $group->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-md p-4">
                    ...
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <dd class="font-mono text-gray-900"><?php echo e($group->branch_key); ?></dd>
                        </div>
                        <div>
                            <dt class="text-gray-500">メンバー数</dt>
                            <dd class="text-gray-900"><?php echo e($group->members->count()); ?>人</dd>
                        </div>
                        <div>
                            <dt class="text-gray-500">作成日</dt>
                            <dd class="text-gray-900"><?php echo e($group->created_at->format('Y年m月d日')); ?></dd>
                        </div>
                        <div>
                            <dt class="text-gray-500">最終更新</dt>
                            <dd class="text-gray-900"><?php echo e($group->updated_at->format('Y年m月d日')); ?></dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                    ...
                    <!-- 削除ボタン -->
                    <form method="POST" action="<?php echo e(route('travel-plans.groups.destroy', [$travelPlan->uuid, $group->id])); ?>" 
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/yasui/develop/trip-quota/resources/views/groups/edit.blade.php ENDPATH**/ ?>