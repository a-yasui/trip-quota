...
<head>
    ...
    <title>新規登録 - <?php echo e(config('app.name', 'TripQuota')); ?></title>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="<?php echo e(route('oauth.redirect', 'google')); ?>"
                    ...
                    <a href="<?php echo e(route('oauth.redirect', 'github')); ?>"
                       class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
...
</html><?php /**PATH /Users/yasui/develop/trip-quota/resources/views/auth/register.blade.php ENDPATH**/ ?>