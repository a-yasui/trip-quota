<?php $__env->startSection('title', $member->name . ' - ' . $travelPlan->plan_name); ?>

<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.container', ['class' => 'max-w-4xl']); ?>
        <?php $__env->startComponent('components.page-header', ['title' => $member->name, 'subtitle' => $travelPlan->plan_name]); ?>
            <?php $__env->slot('action'); ?>
                <?php if($member->user_id !== $travelPlan->owner_user_id): ?>
                    <a href="<?php echo e(route('travel-plans.members.edit', [$travelPlan->uuid, $member->id])); ?>" 
                ...
                <div class="bg-white shadow-sm rounded-lg">
                    ...
                    <div class="px-6 py-4">
                        <div class="flex items-center mb-6">
                            ...
                            <div class="ml-4">
                                <h3 class="text-xl font-medium text-gray-900"><?php echo e($member->name); ?></h3>
                                <p class="text-gray-500"><?php echo e($member->email); ?></p>
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($member->email); ?></dd>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($member->created_at->format('Y年m月d日 H:i')); ?></dd>
                            </div>
                            <?php if($member->confirmed_at): ?>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">確認日</dt>
                                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($member->confirmed_at->format('Y年m月d日 H:i')); ?></dd>
                                </div>
                            <?php endif; ?>
                        </dl>
                    </div>
                                ...
                                <?php $__currentLoopData = $member->groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                                        <div class="flex items-center">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <p class="text-sm font-medium text-gray-900"><?php echo e($group->name); ?></p>
                                                <?php if($group->group_type === 'BRANCH'): ?>
                                                    <p class="text-xs text-gray-500">班キー: <?php echo e($group->branch_key); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    ...
                                                    <p class="mt-0.5 text-sm text-gray-500">
                                                        <?php echo e($member->created_at->format('Y年m月d日 H:i')); ?>
                                            ...
                                            <div class="relative flex space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1">
                                                    <div>
                                                        ...
                                                        <p class="mt-0.5 text-sm text-gray-500">
                                                            <?php echo e($member->confirmed_at->format('Y年m月d日 H:i')); ?>
                    ...
                    <div class="px-6 py-4">
                        <dl class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <dd class="text-sm font-medium text-gray-900"><?php echo e($member->groups->count()); ?>個</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">参加からの日数</dt>
                                <dd class="text-sm font-medium text-gray-900"><?php echo e($member->created_at->diffInDays(now())); ?>日</dd>
                            </div>
                        </dl>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/yasui/develop/trip-quota/resources/views/members/show.blade.php ENDPATH**/ ?>