<?php $__env->startSection('title', '旅程作成 - ' . $travelPlan->plan_name); ?>

<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.container', ['class' => 'max-w-4xl']); ?>
        <?php $__env->startComponent('components.page-header', ['title' => '旅程作成', 'subtitle' => $travelPlan->plan_name . 'の新しい旅程を作成します。']); ?>
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form method="POST" action="<?php echo e(route('travel-plans.itineraries.store', $travelPlan->uuid)); ?>" class="space-y-6 p-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="4"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="詳細な内容、持参物、注意事項などを記載してください..."><?php echo e(old('description')); ?></textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="date" 
                                       id="date" 
                                       name="date" 
                                       value="<?php echo e(old('date', $defaultDate)); ?>"
                        ...
                        <div>
                            ...
                            <select name="group_id" id="group_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                ...
                                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($group->id); ?>" <?php echo e(old('group_id', $defaultGroupId) == $group->id ? 'selected' : ''); ?>>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="transportation_type" id="transportation_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                ...
                                <option value="walking" <?php echo e(old('transportation_type') === 'walking' ? 'selected' : ''); ?>>徒歩</option>
                                <option value="bike" <?php echo e(old('transportation_type') === 'bike' ? 'selected' : ''); ?>>自転車</option>
                                <option value="car" <?php echo e(old('transportation_type') === 'car' ? 'selected' : ''); ?>>車</option>
                                <option value="bus" <?php echo e(old('transportation_type') === 'bus' ? 'selected' : ''); ?>>バス</option>
                                <option value="ferry" <?php echo e(old('transportation_type') === 'ferry' ? 'selected' : ''); ?>>フェリー</option>
                                <option value="airplane" <?php echo e(old('transportation_type') === 'airplane' ? 'selected' : ''); ?>>飛行機</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           id="flight_number" 
                                           name="flight_number" 
                                           value="<?php echo e(old('flight_number')); ?>"
                                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                           placeholder="例：JL123">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('departure_location')); ?>"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('arrival_location')); ?>"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="notes" 
                                      ...
                                      rows="3"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                      placeholder="その他のメモや特記事項..."><?php echo e(old('notes')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/yasui/develop/trip-quota/resources/views/itineraries/create.blade.php ENDPATH**/ ?>