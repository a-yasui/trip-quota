...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TripQuota'); ?></title>
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="<?php echo e(route('invitations.index')); ?>" 
                           class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                            招待
                        </a>
                    </div>
    ...
    <footer class="bg-white border-t border-gray-200 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center text-sm text-gray-500">
                <p>&copy; <?php echo e(date('Y')); ?> TripQuota. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /Users/yasui/develop/trip-quota/resources/views/layouts/master.blade.php ENDPATH**/ ?>